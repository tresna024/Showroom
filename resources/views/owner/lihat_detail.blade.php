...
<head>
    ...
    <style>
        ...
        .card img {
            ...
            object-fit: cover;
            height: 400px;
            /* Atur tinggi gambar agar lebih besar */
        ...
        .col-md-4 {
            max-width: 45%;
            /* Beri ruang lebih pada kolom gambar */
        }

        .col-md-8 {
            max-width: 55%;
            /* Kurangi lebar kolom deskripsi */
        }
        ...
        @media (max-width: 768px) {
            ...
            .card img {
                height: auto;
                /* Sesuaikan tinggi gambar pada layar kecil */
            }
        }
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex">
                        ...
                        <a class="checkout-button" href="{{ route('home_owner') }}">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
