...
@section('content_owner')
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <a href="{{ route('tambah_owner') }}" class="btn btn-success">
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a href="{{ route('lihat_detail_owner', $mobil->id) }}" class="btn btn-dark btn-sm">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <a href="{{ route('edit_owner', $mobil->id) }}" class="btn btn-primary btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form onsubmit="return confirm('Are you sure?');"
                                        action="{{ route('hapus_mobil_owner', $mobil->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
